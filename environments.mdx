...
## See also
- **Authentication** — obtain a client-credentials token: [/authentication](/authentication)
- **Signing Requests** — compute and send `X-Custom-Signature`: [/signing-requests](/signing-requests)
