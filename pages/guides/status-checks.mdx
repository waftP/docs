...
A: Check canonical string order, Base64URL encoding, and that the `kid` matches the registered public key. Ensure `amount` has exactly 2 decimals and timestamp is RFC3339.
