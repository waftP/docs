...
export class PaymentsClient {
  ...
  payoutsInitiate(payload){
    const t = payload.transaction; const o = payload.originator;
    const data = this.canonical({ reference: t.reference, amount: t.amount, country: o.country, service_code: t.service_code });
